        ...
        /*result = new DrawerBuilder()
                ...
                .addDrawerItems(
                       *//* new PrimaryDrawerItem().withSelectable(false).withName(R.string.app_name),
                        new PrimaryDrawerItem().withSelectable(false).withName("Home").withIcon(R.drawable.home).withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                            @Override
                        ...
                        new PrimaryDrawerItem().withSelectable(false).withName("Rate Us").withIcon(R.drawable.rate_us).withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                            @Override
                            public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        new PrimaryDrawerItem().withSelectable(false).withName("Exit").withIcon(R.drawable.exit).withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                            @Override
                            public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                                onBackPressed();
                                return false;
